...
SECRET_KEY = 'django-insecure-8*wo6lslu25hk3y&1an8=lyl^fl+ub=cko65q)h84+g=01g2_#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False
#DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'service-customer-llsg.onrender.com',]
...
DATABASES = {
    ...
    'default': {
	    ...
	    'NAME': 'service_bot',
	    'USER' : 'service_admin',
	    'PASSWORD' : 'P1yJ9Pq6k2dIzimv48NaLSDyvMMNvtSL',
	    'HOST' : 'dpg-cod67hgl5elc73fhinj0-a.frankfurt-postgres.render.com',
	    'PORT' : '5432',
    }
